...
def fetchAndWrite(url, filename):
...
fetchAndWrite("http://www.myneta.info/loksabha2004/index.php?action=show_winners&sort=default", "loksabha_winners2004.csv")
fetchAndWrite("http://www.myneta.info/ls2009/index.php?action=show_winners&sort=default", "loksabha_winners2009.csv")
fetchAndWrite("http://www.myneta.info/ls2014/index.php?action=show_winners&sort=default", "loksabha_winners2014.csv")
